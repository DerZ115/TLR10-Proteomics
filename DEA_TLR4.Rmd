...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_Dark_SN_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_Dark_SN_filtered.csv),
          row.names = FALSE)
...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_LPS_vs_Dark_SN_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_LPS_vs_Dark_SN_filtered.csv),
          row.names = FALSE)
...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_LPS_SN_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_LPS_SN_filtered.csv),
          row.names = FALSE)
...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_Dark_WCL_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_Dark_WCL_filtered.csv),
          row.names = FALSE)
...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_LPS_vs_Dark_WCL_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_LPS_vs_Dark_WCL_filtered.csv),
          row.names = FALSE)
...
write.csv(res, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_LPS_WCL_unfiltered.csv),
          row.names = FALSE)

write.csv(res.sig, file = file.path(results_dir, ASC_TERT_TLR4LOV_Light_vs_LPS_WCL_filtered.csv),
          row.names = FALSE)
